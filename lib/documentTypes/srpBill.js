...
module.exports = {
  ...
  extractor: (keyValues, rawText) => {
    ...
    const fullNameLine = rawText[serviceFromLineIndex + 1];
    ...
    const street_address_line_1 = last5Lines[lastFullNameLineIndex + 1];
    const street_address_line_2 = '';

    // city, state, zip code
    const cityStateZipCodeLine = last5Lines[lastFullNameLineIndex + 2].split(' ');
